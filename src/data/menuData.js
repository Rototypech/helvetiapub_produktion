export const menuData = {
  ...
  cocktails: {
    ...
    items: [
      ...
      { name: 'Margarita', price: '€8.80', description: 'Tequila, triple sec, lime juice' },
      { name: 'Aperol Spritz', price: '€7.50', description: 'Aperol, prosecco, soda water' },
      { name: 'Tequila Shot', price: '€4.00', description: 'Premium tequila with lime and salt' },
      { name: 'Jägermeister', price: '€3.50', description: 'German herbal liqueur' }
    ]
  },
